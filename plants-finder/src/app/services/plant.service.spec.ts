...
describe("PlantService", () => {
  ...
  const testData: IPlant[] = [
    {
      latin_name: "testing o1",
      common_name: "cactus",
      family_name: "green",
      plant_type: "long",
      bloom_time: "summer",
      size_at_maturity: "",
      climate_appropriate_plants: "",
      suitable_site_conditions: "",
      water_needs: "",
      stormwater_benefit: "",
      stormwater_int: "",
      appropriate_location: "",
      suggested_green_connection_routes: "",
      street_tree_list: "",
      ...
      photocredit03: "",
      photocredit04: "",
      sidewalk_landscaping_plants: "",
      sidewalk_landscaping_plants_int: 100
    }
  ];
  ...
  beforeEach(() => {
    ...
    getPlantsSpy = spyOn(service, "getPlants").and.returnValue(of(testData));
    filterPlantsSpy = spyOn(service, "getPlantsByColumnName").and.returnValue(
      of(testData)
    );
  });
  ...
  it("should return return a list of plants for a given limit", inject(
    [PlantService],
  ...
  it("should return return a list of similar plants for a a given search column and value", inject(
    [PlantService],
    (service: PlantService) => {
      service
        .getPlantsByColumnName(columnName, filterValue)
        .subscribe(response => {
          expect(response).toEqual(testData);
